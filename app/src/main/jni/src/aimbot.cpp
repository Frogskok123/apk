...
float GetWeaponId(int WeaponId)
{
    ...
    case 101012: return 0.90;  // Honey Badger
    ...
    case 102002: return 0.6;   // UMP45
    case 102004: return 0.6;   // Thompson
    case 102105: return 0.5;   // P90
    case 102005: return 0.6;   // Bizon
    default: return 0.95;
    }
}
...
void AimBotAuto(ImDrawList *Draw)
{
    ...
    while (1) {
        ...
        float bulletSpeed = (NumIo[11] > 0) ? NumIo[11] : 850.0f;
        float intensity = (NumIo[22] > 0) ? NumIo[22] : 1.0f;
        ...
        float aim_screen_x = vpvp.X;
        float aim_screen_y = vpvp.Y;
        float zm_y = vpvp.X;
        float zm_x = ScreenX - vpvp.Y;
